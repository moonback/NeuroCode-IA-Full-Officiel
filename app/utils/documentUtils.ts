...
import { getDocument, GlobalWorkerOptions } from 'pdfjs-dist'; /* @vite-ignore */
import type { PDFDocumentProxy } from 'pdfjs-dist';

// Configure PDF.js worker dynamically based on environment
let pdfjsWorkerUrl: string;
...
if (typeof window !== 'undefined') {
  ...
  try {
    ...
    pdfjsWorkerUrl = /* @vite-ignore */ new URL('pdfjs-dist/build/pdf.worker.mjs', import.meta.url).href;
  } catch (e) {
    ...
    pdfjsWorkerUrl = 'https://cdn.jsdelivr.net/npm/pdfjs-dist@4.10.38/build/pdf.worker.min.js';
  }
