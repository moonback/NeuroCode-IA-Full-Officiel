                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-[#111827] dark:text-gray-300">Options de l'appareil</span>
                    </div>
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-[#6B7280] dark:text-gray-400">Afficher le cadre de l'appareil</span>
                        <button
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-[#6B7280] dark:text-gray-400">Mode paysage</span>
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-[#6B7280] dark:text-gray-400 group-hover:text-[#6D28D9] dark:group-hover:text-[#6D28D9] transition-colors duration-200">
                          ...
                          {size.hasFrame && showDeviceFrame ? ' (avec cadre)' : ''}
                        </span>
                      </div>
                    </button>
                  ))}
      ...
      <div className="flex-1 border-t border-bolt-elements-borderColor flex justify-center items-center overflow-auto">
        ...
        >
          {activePreview ? (
            ...
            <div className="flex w-full h-full justify-center items-center bg-transparent text-bolt-elements-textPrimary">
