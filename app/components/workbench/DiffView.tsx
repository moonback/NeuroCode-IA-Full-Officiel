...
const InstructionModal = memo(({
  ...
  onSubmit: () => void;
          ...
          <div className="fixed inset-0 z-[10000] bg-black/50 flex items-center justify-center p-6">
            <div className="w-full max-w-lg bg-bolt-elements-background-depth-2 rounded-lg border border-bolt-elements-borderColor shadow-xl overflow-hidden">
              <div className="p-4 border-b border-bolt-elements-borderColor">
                <h3 className="text-lg font-medium text-bolt-elements-textPrimary">Ajouter une instruction au code sélectionnée</h3>
              </div>
              <div className="p-4">
                <textarea
                  className="w-full h-32 p-2 bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor rounded-md text-bolt-elements-textPrimary"
                  placeholder="Entrez votre instruction ici (optionnel)..."
                  value={instruction}
                  onChange={(e) => setInstruction(e.target.value)}
                  autoFocus
                />
              </div>
              <div className="p-4 border-t border-bolt-elements-borderColor flex justify-end gap-2">
                <button
          onClick={onCancel}
                  className="px-4 py-2 rounded-md bg-bolt-elements-background-depth-1 text-bolt-elements-textSecondary hover:bg-bolt-elements-background-depth-3 hover:text-bolt-elements-textPrimary transition-colors"
                >
                  Annuler
                </button>
                <button
