          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div className="mt-4 p-3 bg-[#F5F5F5] dark:bg-[#1A1A1A] rounded-lg">
                <h4 className="text-sm font-medium text-bolt-elements-textSecondary mb-2">Aperçu de la branche</h4>
                <ul className="space-y-2 text-sm text-bolt-elements-textSecondary">
                  ...
                  {branchName && (
                    <li className="flex items-center gap-2">
                      ...
                      La nouvelle branche sera créée comme: {branchName}
                    </li>
                  )}
                  <li className="flex items-center gap-2">
                    <div className="i-ph:check-circle text-green-500" />
                    Basée sur: {sourceBranch}
                  </li>
                </ul>
              </div>
            </div>
