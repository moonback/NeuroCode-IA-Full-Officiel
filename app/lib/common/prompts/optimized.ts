...
import { logger } from '~/utils/logger'; // Assurez-vous que le logger est accessible
...
export const getSystemPrompt = (cwd: string = WORK_DIR, customPrompt?: string) => {
  ...
  logger.debug('Utilisation du prompt Optimisé');
  return stripIndents`  
...
Important: All answers must be in French unless the user requests another language.<system_constraints>
